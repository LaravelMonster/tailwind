...
export default props => (<div className="animated fadeIn box flex flex-wrap border border-red rounded-sm shadow-lg bg-grey-lightest  border-t-4 p-8 max-w-sm mx-auto mt-8">
    ...
    <label className="pt-4 text-grey-darkest text-sm cursor-pointer">
